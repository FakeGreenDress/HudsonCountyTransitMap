...
<qgis version="2.2.0-Valmiera" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="wheelchair" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="" label=""/>
      <category symbol="1" value="no" label="no"/>
      <category symbol="2" value="yes" label="yes"/>
    </categories>
    <symbols>
      <symbol alpha="0" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="182,128,61,255"/>
      ...
      <symbol alpha="1" type="marker" name="1">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="175,161,248,255"/>
          <prop k="color_border" v="0,0,0,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="circle"/>
          <prop k="offset" v="0,0"/>
      ...
      <symbol alpha="1" type="marker" name="2">
        ...
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#ffffff"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="amenity/amenity_toilets_disabled.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
    ...
    <source-symbol>
      <symbol alpha="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="249,105,237,255"/>
          <prop k="color_border" v="0,0,0,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="circle"/>
          <prop k="offset" v="0,0"/>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="0" name="COUNTYP010"/>
    <edittype labelontop="0" editable="1" type="0" name="FIPS"/>
    <edittype labelontop="0" editable="1" type="0" name="NJDOT_SRI"/>
    <edittype labelontop="0" editable="1" type="0" name="PERIMETER"/>
    <edittype labelontop="0" editable="1" type="0" name="SQUARE_MIL"/>
    <edittype labelontop="0" editable="1" type="0" name="STATE"/>
    <edittype labelontop="0" editable="1" type="0" name="STATE_FIPS"/>
    ...
    <edittype labelontop="0" editable="1" type="0" name="bicycle_pa"/>
    <edittype labelontop="0" editable="1" type="0" name="bus"/>
    <edittype labelontop="0" editable="1" type="0" name="crossing"/>
    ...
    <edittype labelontop="0" editable="1" type="0" name="geographic"/>
    <edittype labelontop="0" editable="1" type="0" name="gnis_count"/>
    <edittype labelontop="0" editable="1" type="0" name="highway"/>
    <edittype labelontop="0" editable="1" type="0" name="id"/>
    <edittype labelontop="0" editable="1" type="0" name="landmark"/>
    <edittype labelontop="0" editable="1" type="0" name="name"/>
    <edittype labelontop="0" editable="1" type="0" name="name_en"/>
    <edittype labelontop="0" editable="1" type="0" name="official_n"/>
    <edittype labelontop="0" editable="1" type="0" name="park_ride"/>
    <edittype labelontop="0" editable="1" type="0" name="platforms"/>
    <edittype labelontop="0" editable="1" type="0" name="public_tra"/>
    <edittype labelontop="0" editable="1" type="0" name="rail"/>
    <edittype labelontop="0" editable="1" type="0" name="railway"/>
    <edittype labelontop="0" editable="1" type="0" name="short_name"/>
    <edittype labelontop="0" editable="1" type="0" name="toilets"/>
