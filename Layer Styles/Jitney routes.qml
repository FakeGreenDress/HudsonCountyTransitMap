...
<qgis version="2.2.0-Valmiera" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="bus_line" symbollevels="0" type="categorizedSymbol">
    <categories>
      ...
      <category symbol="1" value="bayonne_journal" label="bayonne_journal"/>
      <category symbol="2" value="bergenline" label="bergenline"/>
      <category symbol="3" value="blvd_east" label="blvd_east"/>
      <category symbol="4" value="fairview" label="fairview"/>
      <category symbol="5" value="kennedy_blvd" label="kennedy_blvd"/>
      <category symbol="6" value="kennedy_pa" label="kennedy_pa"/>
      <category symbol="7" value="ny_42_street" label="ny_42_street"/>
      <category symbol="8" value="ny_paterson_gwb" label="ny_paterson_gwb"/>
      <category symbol="9" value="paterson_pa" label="paterson_pa"/>
      <category symbol="10" value="river_road" label="river_road"/>
    ...
    <symbols>
      ...
      <symbol alpha="1" type="line" name="3">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="color" v="253,181,105,255"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_unit" v="MM"/>
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
      ...
      <symbol alpha="1" type="line" name="8">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="color" v="178,224,166,255"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_unit" v="MM"/>
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
      ...
      <symbol alpha="1" type="line" name="9">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="color" v="136,196,170,255"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_unit" v="MM"/>
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
