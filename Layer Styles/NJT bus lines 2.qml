...
<qgis version="2.2.0-Valmiera" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="&quot;ROUTE_DIR&quot;  LIKE '%I%'" symbollevels="0" type="categorizedSymbol">
    <categories>
    ...
    <source-symbol>
      <symbol alpha="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="color" v="236,227,139,255"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_unit" v="MM"/>
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="LINE"/>
  ...
  <edittypes>
    <edittype labelontop="0" editable="1" type="0" name="BEG_MILE"/>
    <edittype labelontop="0" editable="1" type="0" name="END_MILE"/>
    <edittype labelontop="0" editable="1" type="0" name="LINE"/>
    <edittype labelontop="0" editable="1" type="0" name="PATTERN"/>
    <edittype labelontop="0" editable="1" type="0" name="PICK_DATE"/>
    <edittype labelontop="0" editable="1" type="0" name="ROUTE_DIR"/>
    ...
    <edittype labelontop="0" editable="0" type="0" name="filtered njt_LINE"/>
    <edittype labelontop="0" editable="0" type="0" name="filtered njt_MAX"/>
    <edittype labelontop="0" editable="0" type="0" name="filtered njt_Max_Leng"/>
