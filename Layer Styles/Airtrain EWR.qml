...
<qgis version="2.2.0-Valmiera" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <edittypes>
    <edittype labelontop="0" editable="1" type="0" name="HFCS"/>
    <edittype labelontop="0" editable="1" type="0" name="NRHP"/>
    ...
    <edittype labelontop="0" editable="1" type="0" name="bus"/>
    <edittype labelontop="0" editable="1" type="0" name="cycleway"/>
    <edittype labelontop="0" editable="1" type="0" name="cycleway:left"/>
    <edittype labelontop="0" editable="1" type="0" name="cycleway:right"/>
    <edittype labelontop="0" editable="1" type="0" name="description"/>
    <edittype labelontop="0" editable="1" type="0" name="electrified"/>
    <edittype labelontop="0" editable="1" type="0" name="foot"/>
    <edittype labelontop="0" editable="1" type="0" name="frequency"/>
    <edittype labelontop="0" editable="1" type="0" name="gauge"/>
    <edittype labelontop="0" editable="1" type="0" name="gnis:county_id"/>
    <edittype labelontop="0" editable="1" type="0" name="gnis:county_name"/>
    <edittype labelontop="0" editable="1" type="0" name="gnis:feature_id"/>
    <edittype labelontop="0" editable="1" type="0" name="gnis:state_id"/>
    ...
    <edittype labelontop="0" editable="1" type="0" name="name:en"/>
    ...
    <edittype labelontop="0" editable="1" type="0" name="old_name:Conrail"/>
    <edittype labelontop="0" editable="1" type="0" name="old_railway_operator"/>
    ...
    <edittype labelontop="0" editable="1" type="0" name="tiger:county"/>
    <edittype labelontop="0" editable="1" type="0" name="tiger:name_base_2"/>
    <edittype labelontop="0" editable="1" type="0" name="tiger:name_type_1"/>
    <edittype labelontop="0" editable="1" type="0" name="tiger:name_type_2"/>
